...
El síntoma más engañoso de un negocio con margen negativo es que parece funcionar. Hay ventas, hay depósitos, hay actividad. El problema aparece cuando después de pagar proveedores, ML, envíos y costos operativos, lo que queda es menos de lo que entraste. Estás financiando a tus compradores sin darte cuenta.

## Las tres señales de que estás perdiendo
...
Si el resultado es negativo, estás perdiendo. Si es menor al 15%, estás en zona de riesgo.

## Ejemplo con números reales

**Producto:** accesorio para hogar  
**Precio de publicación:** $22.000 CLP  
**Costo del producto:** $14.000 CLP  
**Comisión:** 13% (categoría Hogar)  
**Publicación:** Premium, paquete 500g ($3.990 envío)

```
Comisión + IVA = $22.000 × 0,13 × 1,19 = $3.403
Ingreso neto = $22.000 − $3.403 − $3.990 = $14.607
Margen = ($14.607 − $14.000) ÷ $22.000 × 100 = 2,8%
```

El vendedor creía ganar $8.000 por venta (diferencia precio-costo). Gana $607. El 97,2% del margen aparente lo devoran las comisiones y el envío.

## Qué hacer si el margen es negativo o muy bajo
...
**Reducir el costo del producto.** Mejor precio de proveedor por volumen, cambio de proveedor, reducción de especificaciones innecesarias.
