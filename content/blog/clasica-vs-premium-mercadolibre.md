...
**Cuando los márgenes son muy ajustados.** Si tu margen bruto ya es menor al 20%, absorber el envío puede volverte negativo. Clásica te da más control.

## Cuándo Premium sí conviene

**Productos livianos y de precio medio-alto.** Un producto de $50.000 con paquete de 500g paga $3.990 de envío — menos del 8% del precio. El costo de visibilidad es razonable.

**Categorías muy competidas.** Si tu categoría tiene decenas de vendedores y los compradores filtran por "envío gratis", no aparecer en ese filtro te deja fuera del juego.

**Productos con margen amplio.** Si tu margen bruto sin envío es mayor al 30%, absorber $4.000–$6.000 de envío sigue dejando un negocio rentable.
...
- Descuento: comisión + IVA
- Margen = (Precio − Comisión+IVA − Costo) ÷ Precio

**Escenario Premium:**
- Precio de publicación: $X (o ligeramente mayor para compensar envío)
- Descuento: comisión + IVA + costo de envío
- Margen = (Precio − Comisión+IVA − Envío − Costo) ÷ Precio

Luego estimá cuántas unidades extra genera Premium por el mayor tráfico. Si el mayor volumen compensa el menor margen por unidad, Premium gana. Si no, Clásica.

No hay respuesta universal — hay análisis por producto.

**[Comparar margen Clásica vs Premium para tu producto →](https://margenreal.io/calculadora-ml)**
