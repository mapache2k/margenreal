...
export default function AdminMercadoLibre() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (data.error === 'no_auth') { setConnected(false); return; }
          ...
          {!connecting && connected === false && (
            <div className="ml-connect-box">
              ...
              <p className="ml-connect-desc">
                Iniciá sesión una sola vez con tu cuenta de MercadoLibre Chile.<br />
                El token queda guardado — no necesitás volver a conectar.
              </p>
