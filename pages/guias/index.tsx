...
export default function GuiasIndex({ guias }: Props) {
  return (
    <Layout>
      ...
      <style>{`
        .guias-list { max-width: var(--content-max); margin: 0 auto; padding: 0 var(--section-x) 80px; display: grid; gap: 1px; }
        ...
        .empty { max-width: var(--content-max); margin: 0 auto; padding: 0 var(--section-x) 80px; text-align: center; color: var(--muted); }
      `}</style>
